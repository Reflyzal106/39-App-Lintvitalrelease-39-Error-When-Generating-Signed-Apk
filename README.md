# [SOLVED] 39-App-Lintvitalrelease-39-Error-When-Generating-Signed-Apk
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/39-app-lintvitalrelease-39-error-when-generating-signed-apk)
>
...
Use a release build variant and verify your lint configuration to fix the issue.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/39-app-lintvitalrelease-39-error-when-generating-signed-apk)**
